...
//         <h2 className="mb-6 text-center text-2xl font-bold text-slate-800">Welcome to MoodSnap</h2>
...
//               className="w-full rounded-lg border border-slate-300 p-3 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all"
//             />
//           </div>
...
//               className="w-full rounded-lg border border-slate-300 p-3 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all bg-white"
//             >
...
//           <button 
//             type="submit" 
//             className="w-full rounded-lg bg-indigo-600 p-3 font-semibold text-white transition-colors hover:bg-indigo-700 active:bg-indigo-800"
//           >
//             Login
//           </button>
//         </form>
